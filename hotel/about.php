...
<body>
    ...
    <div class="row" style="color: white">
            <div class="col-md-4 wellfix">
              <h4><strong style="color: red">About us</strong></h4><br>
              <br><hr>
              <p>BookMeHotel reservations are a popular method for booking hotel rooms. Travelers can book rooms on a computer by using online security to protect their privacy and financial information and by using several online travel agents to compare prices and facilities at different hotels</p>
              <br>
              ...
              <br>
              <p>BookMeHotel reservations are also helpful for making last minute travel arrangements. Hotels may drop the price of a room if some rooms are still available. There are several websites that specialize in searches for deals on rooms.</p>
              <p>BookMeHotel is No.1 online hotel booking site in Lebanon.</p><br>
